...
echo "# Index" > $TEMP_MD
cat ../../aaron/lbc1689-index.md >> $TEMP_MD
printf "\n\n" >> $TEMP_MD

# Add the introduction
echo "# Introduction" >> $TEMP_MD
cat ../../aaron/lbc1689-introduction.md >> $TEMP_MD
echo "\n\n" >> $TEMP_MD

# Concatenate all chapter files
for chapter in ../../aaron/lbc1689-ch*.md; do
    echo "\newpage" >> $TEMP_MD
    cat "$chapter" >> $TEMP_MD
    echo "\n\n" >> $TEMP_MD
done
...
cat ../../aaron/lbc1689-signatories.md >> $TEMP_MD
echo "\n\n" >> $TEMP_MD

# Add the addendums at the last pages
echo "# Addendums" >> $TEMP_MD
cat ../../aaron/Addendums.md >> $TEMP_MD
